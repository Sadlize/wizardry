...
async function handleResponse({ url, options }: { url: Url; options: RequestInit }) {
...
const methods: Record<Method, (path: Url, options?: Options, token?: string) => ReturnType<typeof generateMethod>> = {
